...
#include "stanExports_saeHB_TF_beta.h"

RCPP_MODULE(stan_fit4saeHB_TF_beta_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_saeHB_TF_beta")
